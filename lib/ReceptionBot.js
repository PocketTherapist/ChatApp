...
//ユーザーからの返信を取得する。
ReceptionBot.prototype.getAnswer = function(questionId,selectedOption,nextId,name){
   this.questionId = questionId;
   this.selectedOption = selectedOption;
   this.NextAction(nextId,name);
}


//引数ありでもなしでもよい。
ReceptionBot.prototype.NextAction = function(nextId,name){
   var realNextId;
   if(nextId !== undefined){
