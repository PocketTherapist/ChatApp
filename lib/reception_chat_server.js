...
exports.listen = function(server){
   ...
   io.sockets.on('connection',function(socket){
      ...
      socket.on("nextOfBackPainTypeQForm",function(data){
         console.log("nextOfBackPainTypeQForm" + data.Next);
          botApp.getQResult(data.Next);
      });
      ...
      socket.on("nextOfTherapistChat",function(data){
         console.log("nextOfTherapistChat server side:" + data.Next)
         botApp.NextAction(data.Next);
         botApp.NextAction();
      });
